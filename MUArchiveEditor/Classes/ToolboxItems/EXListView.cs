...
namespace MinecraftUArchiveExplorer {
    ...
    public abstract class EXListViewSubItemAB : ListViewItem.ListViewSubItem {
        ...
        public abstract int DoDraw(DrawListViewSubItemEventArgs e, int x, MinecraftUArchiveExplorer.EXColumnHeader ch);
    ...
    public class EXListViewSubItem : EXListViewSubItemAB {
        ...
        public override int DoDraw(DrawListViewSubItemEventArgs e, int x, MinecraftUArchiveExplorer.EXColumnHeader ch) {
            return x;
        }
